      ...
      <div className="relative">
        ...
        {hasValidUrl && (
          ...
          <Textarea
            ...
            className="min-h-[50px] md:min-h-[80px] resize-none border-0 bg-transparent text-center text-sm text-white placeholder:text-white placeholder:font-medium placeholder:tracking-wide focus-visible:ring-0 focus-visible:ring-offset-0"
          />
        </div>
      </div>
